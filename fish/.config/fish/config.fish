...
# Fix sudo with oh-my-posh - disable key bindings that interfere with password input
function sudo
    set -l old_bindings $fish_key_bindings
    set -e fish_key_bindings
    command sudo $argv
    set -g fish_key_bindings $old_bindings
end
